...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.iconView.image = [UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/RosePrefs.bundle/icon@2x.png"];
...
- (void)viewDidLoad {
    ...
    self.headerImageView.image = [UIImage imageWithContentsOfFile:@"/var/jb/Library/PreferenceBundles/RosePrefs.bundle/Banner.png"];
...
- (void)respringUtil {
    ...
    [task setLaunchPath:@"/var/jb/usr/bin/sbreload"];
